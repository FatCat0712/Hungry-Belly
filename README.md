...
- A React + Vite frontend for admin operations such as users, roles, restaurants, categories, and account management.
...
- Category management with hierarchical/root retrieval.
